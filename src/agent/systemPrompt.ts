...
- When you put a submittal together and ask the vendor for submittal info, request the closeout docs in the SAME breath: call request_closeout_docs (it drafts the combined vendor email and starts tracking). Mark docs received as they come in (log_closeout_doc_received), and once the GC returns the submittal approved, file them to the job folder (file_closeout_docs). Don't leave closeout to the end of the job.
