...
const SAMPLE: Car[] = [
  ...
  // ---- DCAP-eligible plug-ins & EVs (2018+, <75k mi) ----
  {
    id: "mock-volt-2019",
    year: 2019,
    make: "Chevrolet",
    ...
    bodyStyle: "hatchback",
    seats: 5,
    dealerName: "Stockton Honda",
    city: "Stockton",
    state: "CA",
    distanceMiles: 46,
    listingUrl: "https://www.cars.com/shopping/chevrolet-volt/sacramento-ca/",
    source: "Sample data",
  },
  {
    id: "mock-niro-phev-2019",
    year: 2019,
    make: "Kia",
    ...
    state: "CA",
    distanceMiles: 9,
    listingUrl: "https://www.cargurus.com/Cars/l-Used-Kia-Niro-Hybrid-Plug-In-Sacramento-d2653_L2795",
    source: "Sample data",
  },
  {
    id: "mock-ioniq-phev-2018",
    year: 2018,
    make: "Hyundai",
    ...
    state: "CA",
    distanceMiles: 66,
    listingUrl: "https://www.cargurus.com/Cars/l-Used-Hyundai-Ioniq-Hybrid-Plug-In-Sacramento-d2685_L2795",
    source: "Sample data",
  },
  {
    id: "mock-leaf-plus-2019",
    year: 2019,
    make: "Nissan",
    model: "Leaf",
    trim: "SV Plus",
    ...
    state: "CA",
    distanceMiles: 45,
    listingUrl: "https://www.cars.com/shopping/nissan-leaf/sacramento-ca/",
    source: "Sample data",
  },
  {
    id: "mock-fusion-energi-2018",
    year: 2018,
    make: "Ford",
    model: "Fusion Energi",
    trim: "SE",
    ...
    state: "CA",
    distanceMiles: 40,
    listingUrl: "https://www.cars.com/shopping/ford-fusion_energi/sacramento-ca/",
    source: "Sample data",
  },
];
